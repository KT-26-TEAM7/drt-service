...
class TMapClient:
    def __init__(self, app_key: str | None = TMAP_APP_KEY, base_url: str = TMAP_BASE_URL) -> None:
        if not app_key:
    ...
    async def _request(self, method: str, path: str, *, params: dict[str, Any] | None = None, json: dict[str, Any] | None = None) -> dict[str, Any]:
        ...
        try:
            ...
            raise TMapAPIError("TMAP API 응답이 올바른 JSON 형식이 아닙니다.") from error
