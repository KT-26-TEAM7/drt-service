...
def _describe_destination(destination: DestinationCandidate) -> str:
...
def build_destination_search_response(
    ...
    if total_count == 1:
        ...
        return DestinationSearchResponse(
            ...
            message=(
                f"검색된 장소는 {_describe_destination(destination)}입니다. "
                "이곳으로 이동하시겠습니까?"
            ),
