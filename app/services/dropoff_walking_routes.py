"""하차 정류장 후보에서 목적지까지의 보행 경로를 계산한다."""
...
from app.schemas.stop import DropoffStopCandidate, StopWalkingRoute
...
async def calculate_walking_route(
    candidate: DropoffStopCandidate,
...
async def calculate_walking_routes(
    candidates: list[DropoffStopCandidate],
    destination: DestinationCandidate,
    client: TMapClient | None = None,
